    ...
    <div
      ...
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        <a className="w-[19rem] xl:mr-8 flex" href="#hero">
          <img src={Artisticlogo} width={70} height={20} alt="codeplanet" />
          <h1 className="font-tt font-bold tracking-widest my-6 px-3">Artistic Aura<span className="hidden lg:inline md:inline sm:inline"></span></h1>
        </a>
